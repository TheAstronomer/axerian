...
const CONJ = /[bcCdDXfgGhHklmnQprsStTvwzZ]j|[kgQHh]w/ // Initial only
...
// * Final consonants
const LCONF = /l[pftTsScCkbvdDzZXGgn]|n[pftTsScCkbvdDzZXGg]|r[pftTsScCkbvdDzZXGgln]|h[pftTsScCkbvdDzZXGglLnNrR]/
...
function capitalize(word, trans) {
    ...
    if (_.sortedUniq(iscap) == [0, 1]) return trans.toUpperCase()
        ...
        return cap.join('') + SliceArray(trans)[[i, '']]
    }
}
...
var arr = []
for (var i of range(100)) arr.push(genWord(2))
console.log(arr)
